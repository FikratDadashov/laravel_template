    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form class="form needs-validation" novalidate="" action="{{url('admin/blog/'.$blog->id.'/update/')}}" method="POST"
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <img src="{{url('assets/uploads/'.$blog->image)}}" alt="image" width="150" height="150">
                                <div class="col-8 border-left pb-2 pt-2">
