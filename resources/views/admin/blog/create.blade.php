                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a
                                    href="{{url('/admin/blog')}}">Bloglar</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Yeni blog yarat</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form class="form needs-validation" novalidate="" action="{{url('admin/blog')}}" method="post" enctype="multipart/form-data">
                            @csrf
