                ...
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Readktə et</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form class="form needs-validation" novalidate="" action="{{url('admin/testimonial/'.$testimonial->id.'/update/'.$language_id)}}" method="POST"
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-8 border-left pb-2 pt-2">
                                    <input required type="text" class="form-control" id="title" name="title" required
                                           placeholder="Başlıq"
                                           value="{{ $testimonial_text ? $testimonial_text->title : '' }}">
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-8 border-left pb-2 pt-2">
                                    <textarea required name="text"
                                              id="elm1"> {{$testimonial_text ? $testimonial_text->text : ''}}</textarea>
                                    <div class="invalid-feedback">
                                        Doldurulmalıdır
                                    </div>
                                </div>
