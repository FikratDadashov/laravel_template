    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form class="form needs-validation" novalidate="" action="{{url('admin/slide/'.$slide->id.'/update/')}}" method="POST"
                                ...
                                <div class="col-8 border-left pb-2 pt-2">
                                    <select required class="form-control" name="status_id">
                                        ...
                                        @foreach($statuses as $status)
                                            <option
                                                value="{{$status->id}}" {{$slide->status_id == $status->id ? 'selected':''}}>{{$status->name}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <img src="{{url('assets/uploads/'.$slide->image)}}" alt="image" width="150" height="150">
                                <div class="col-8 border-left pb-2 pt-2">
