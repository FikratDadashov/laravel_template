                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a
                                    href="{{url('/admin/slide')}}">Slaydlar</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Yeni slayd yarat</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form class="form needs-validation" novalidate="" action="{{url('admin/slide')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-8 border-left pb-2 pt-2">
                                    <input type="text" class="form-control" id="title" name="title" required
                                           placeholder="Başlıq"
                                           value="{{old('title', $operation == 'create' ? '':$slide->title)}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row align-items-center mb-0">
                                ...
                                <div class="col-8 border-left pb-2 pt-2">
                                    <textarea required name="text" class="form-control" id="elm1">{{old('text', $operation == 'create' ? '':$slide->text)}}</textarea>
                                    <div class="invalid-feedback">
                                        Required
                                    </div>
                                </div>
