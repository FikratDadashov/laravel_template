                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a
                                    href="{{url('/admin/messages')}}">Haqqımızda</a></li>
                            <?php
                            if ($operation == 'create')
                                $title = 'Yeni Mətn yarat';
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{url('admin/about')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="lang_id" value="{{$lang_id}}" class="form-control">
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-8 border-left pb-2 pt-2">
                                    <textarea name="text"
                                              id="summernote"> {{old('text', $operation == 'create' ? '':'')}}</textarea>
                                </div>
                            </div>
