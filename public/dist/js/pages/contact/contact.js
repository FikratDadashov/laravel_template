...
function checkall(clickchk, relChkbox) {
	...
	checkall('messages-check-all', 'messages-chkbox');
	...
	$('#btn-add-messages').on('click', function(event) {
						...
						'<td>' +
							'<div class="n-chk align-self-center text-center">' +
								'<div class="custom-control custom-checkbox">' +
									'<input type="checkbox" class="custom-control-input messages-chkbox" id="'+cdate+'">' +
...
$(".delete-multiple").on("click", function() {
		var inboxCheckboxParents = $(".messages-chkbox:checked").parents('.search-items');
